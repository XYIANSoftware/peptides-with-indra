...
- **OG and Twitter images**: `src/app/opengraph-image.tsx` and `src/app/twitter-image.tsx` generate a 1200×630 PNG (brand gradient, site name, tagline) via Next.js `ImageResponse`; shared on social and in link previews.
